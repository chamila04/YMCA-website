...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2024 at 06:20 PM
...
--
ALTER TABLE `court_book`
  MODIFY `cbook_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `room_book`
  MODIFY `rbook_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
